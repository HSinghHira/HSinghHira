...
function MarkerPopup({
  ...
  useEffect(() => {
    if (!map || !marker || !popup || !container) return;
  ...
  if (!marker || !popup || !container) return null;
...
function MarkerTooltip({
  ...
  useEffect(() => {
    if (!map || !marker || !tooltip || !container) return;
  ...
  if (!marker || !tooltip || !container) return null;
...
function MapPopup({
  ...
  if (!map || !popup || !container) return null;
